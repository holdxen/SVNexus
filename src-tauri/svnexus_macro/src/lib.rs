...
use syn::{
    Data, DeriveInput, Expr, Fields, Ident, Token,
...
pub fn messagepack_command(attr: TokenStream, item: TokenStream) -> TokenStream {
    command::messagepack_command_impl(attr, item)
}
