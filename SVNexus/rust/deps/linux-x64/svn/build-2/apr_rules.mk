...
#
apr_builddir=/usr/local/svn/build-2
apr_builders=/usr/local/svn/build-2

# Some layouts require knowing what version we are at.
APR_MAJOR_VERSION=2
APR_DOTTED_VERSION=2.0.0
...
CFLAGS=
CPPFLAGS=
LDFLAGS=-L/usr/local/svn/lib64 -L/usr/local/svn/lib
LIBS=
DEFS=-DHAVE_CONFIG_H
...
EXTRA_LDFLAGS=
EXTRA_LIBS=-lcrypt -lrt -lcrypt  -lpthread -ldl -lexpat
EXTRA_INCLUDES=-I/usr/local/svn/include
